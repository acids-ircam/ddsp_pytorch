...
#include "KlingKlangKlong.DDSP_realtime.cpp"    // need the source of our object so that we can access it
...
//
//        test_wrapper<KlingKlangKlong_DDSP_realtime> an_instance;
//        KlingKlangKlong_DDSP_realtime&              my_object = an_instance;
//
